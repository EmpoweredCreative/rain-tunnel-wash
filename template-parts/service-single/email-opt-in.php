<?php
/**
 * Service Single - Email opt-in (same as home, brand blue background)
 *
 * @package RainTunnelWash
 */

$heading = get_field('service_email_heading') ?: 'Local car wash deals and updates delivered to your inbox.';
$subtext = get_field('service_email_subtext') ?: 'No spam, just helpful updates and irresistible offers.';
?>
