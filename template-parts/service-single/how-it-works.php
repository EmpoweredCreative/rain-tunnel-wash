<?php
/**
 * Service Single - How it works: heading, paragraph, 4 icons with text
 *
 * @package RainTunnelWash
 */

$heading = get_field('service_how_heading');
$paragraph = get_field('service_how_paragraph');
$icons = get_field('service_how_icons');
...
<section class="section service-single-how">
    <div class="container">
        ...
        <?php endif; ?>
        <?php if ($paragraph) : ?>
            <div class="service-single-how__paragraph"><?php echo wp_kses_post(wpautop($paragraph)); ?></div>
        <?php endif; ?>
