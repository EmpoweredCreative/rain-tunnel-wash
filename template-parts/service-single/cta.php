<?php
/**
 * Service Single - CTA (same as services landing page)
 *
 * @package RainTunnelWash
 */

$heading   = get_field('service_cta_heading');
$text      = get_field('service_cta_text');
$button    = get_field('service_cta_button');
$btn_text  = get_field('service_cta_button_text');
$bg_image  = get_field('service_cta_background_image');
