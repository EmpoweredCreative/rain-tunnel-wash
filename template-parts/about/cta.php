<?php
/**
 * About / Who We Are - CTA (same as contact page CTA section)
 *
 * @package RainTunnelWash
 */

$post_id      = get_queried_object_id() ?: get_the_ID();
$heading      = $post_id ? get_field( 'about_cta_heading', $post_id ) : null;
$text         = $post_id ? get_field( 'about_cta_text', $post_id ) : null;
$button       = $post_id ? get_field( 'about_cta_button', $post_id ) : null;
$btn_text     = $post_id ? get_field( 'about_cta_button_text', $post_id ) : null;
$bg_image     = $post_id ? get_field( 'about_cta_background', $post_id ) : null;
