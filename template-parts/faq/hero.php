<?php
/**
 * FAQ Page - Hero (same structure as program single / location single)
 *
 * @package RainTunnelWash
 */

$badge        = get_field( 'faq_hero_badge' );
$tagline_raw  = get_field( 'faq_hero_tagline' );
$tagline      = ( $tagline_raw !== null && trim( (string) $tagline_raw ) !== '' ) ? trim( (string) $tagline_raw ) : '';
$title        = get_field( 'faq_hero_title' ) ?: get_the_title();
$subtitle     = get_field( 'faq_hero_subtitle' ) ?: '';
$desc         = get_field( 'faq_hero_description' ) ?: '';
$hero_image   = get_field( 'faq_hero_image' );
$cta1_text_raw = get_field( 'faq_hero_cta1_text' );
$cta1_link_raw = get_field( 'faq_hero_cta1_link' );
$cta2_text_raw = get_field( 'faq_hero_cta2_text' );
$cta2_link_raw = get_field( 'faq_hero_cta2_link' );
